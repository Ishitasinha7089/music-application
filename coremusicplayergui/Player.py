...
class Player:
    def __init__(self):
        mixer.init()  #isse ham pygame to active kr rhe h ...uske constructor rko call krke..mtlb pygame ka object ban rha h
        self.my_model=Model.Model()  #model ka object..to access methods of model class
